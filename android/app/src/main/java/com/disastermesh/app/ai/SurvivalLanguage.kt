...
enum class SurvivalLanguage(
    ...
    // ── Languages 81–140+ (extended multilingual coverage) ─────────────────
    ...
    TATAR       ("tt",  "Tatar",                "Татарча"),
    BASHKIR     ("ba",  "Bashkir",              "Башҡортса"),
    CHECHEN     ("ce",  "Chechen",              "Нохчийн"),
    KURDISH_KURMANJI("ku", "Kurdish (Kurmanji)", "Kurmancî"),
    KURDISH_SORANI("ckb", "Kurdish (Sorani)",    "سۆرانی"),
    OROMO       ("om",  "Oromo",                "Afaan Oromoo"),
    TIGRINYA    ("ti",  "Tigrinya",             "ትግርኛ"),
    KINYARWANDA ("rw",  "Kinyarwanda",          "Ikinyarwanda"),
    KIRUNDI     ("rn",  "Kirundi",              "Ikirundi"),
    LINGALA     ("ln",  "Lingala",              "Lingála"),
    SHONA       ("sn",  "Shona",                "ChiShona"),
    SESOTHO     ("st",  "Sesotho",              "Sesotho"),
    TSWANA      ("tn",  "Tswana",               "Setswana"),
    SWATI       ("ss",  "Swati",                "SiSwati"),
    TSONGA      ("ts",  "Tsonga",               "Xitsonga"),
    NDEBELE     ("nd",  "Ndebele",              "isiNdebele"),
    WOLOF       ("wo",  "Wolof",                "Wolof"),
    FULA        ("ff",  "Fula",                 "Fulfulde"),
    BAMBARA     ("bm",  "Bambara",              "Bamanankan"),
    AKAN        ("ak",  "Akan",                 "Akan"),
    EWE         ("ee",  "Ewe",                  "Eʋegbe"),
    BERBER      ("tzm", "Tamazight (Berber)",   "Tamaziɣt"),
    HMONG       ("hmn", "Hmong",                "Hmoob"),
    TIBETAN     ("bo",  "Tibetan",              "བོད་ཡིག"),
    DZONGKHA    ("dz",  "Dzongkha",             "རྫོང་ཁ"),
    DHIVEHI     ("dv",  "Dhivehi",              "ދިވެހި"),
    GUARANI     ("gn",  "Guarani",              "Avañe'ẽ"),
    AYMARA      ("ay",  "Aymara",               "Aymar aru"),
    NAHUATL     ("nah", "Nahuatl",              "Nāhuatl"),
    NAVAJO      ("nv",  "Navajo",               "Diné Bizaad"),
    INUKTITUT   ("iu",  "Inuktitut",            "ᐃᓄᒃᑎᑐᑦ"),
    CREE        ("cr",  "Cree",                 "Nehiyaw"),
    OJIBWE      ("oj",  "Ojibwe",               "Ojibwemowin"),
    FIJIAN      ("fj",  "Fijian",               "Na Vosa Vakaviti"),
    TONGAN      ("to",  "Tongan",               "Lea Faka-Tonga"),
    TAHITIAN    ("ty",  "Tahitian",             "Reo Tahiti"),
    TOK_PISIN   ("tpi", "Tok Pisin",            "Tok Pisin"),
    INTERLINGUA ("ia",  "Interlingua",          "Interlingua"),
    CANTONESE   ("yue", "Cantonese",            "粵語"),
    WU_CHINESE  ("wuu", "Wu Chinese",           "吴语"),
    HAKKA       ("hak", "Hakka Chinese",        "客家話"),
    MIN_NAN     ("nan", "Min Nan Chinese",      "閩南語"),
    YI          ("ii",  "Nuosu Yi",             "ꆇꉙ");
